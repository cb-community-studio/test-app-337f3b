...
import AsdfghgfdsPage from "../components/AsdfghgfdsPage/AsdfghgfdsPage";
import SingleAsdfghgfdsPage from "../components/AsdfghgfdsPage/SingleAsdfghgfdsPage";
// ~cb-add-import~
        ...
        <div className={wrapperClass} onClick={onWrapperClick}>
            ...
            <MainLayout>
                <Switch>
                    ...
                    <Route path="/asdfghgfds" component={AsdfghgfdsPage} exact />
                    <Route path="/asdfghgfds/:singleAsdfghgfdsId" component={SingleAsdfghgfdsPage} exact />
                    {/* ~cb-add-route~ */}
