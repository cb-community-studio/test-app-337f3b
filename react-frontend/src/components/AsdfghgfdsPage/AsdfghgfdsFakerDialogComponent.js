...
import asdfghgfdsFakerFactory from "./asdfghgfdsFakerFactory";
...
const AsdfghgfdsFakerDialogComponent = (props) => {
    ...
    const onRun = async () => {
        let fakeData = asdfghgfdsFakerFactory(fakerCount);

        setLoading(true);
        const promises = fakeData.map((elem) => client.service("asdfghgfds").create(elem));
...
export default connect(null, mapDispatch)(AsdfghgfdsFakerDialogComponent);
